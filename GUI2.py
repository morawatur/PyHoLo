...
class TriangulateWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.tab_nav.layout.addWidget(prev_button, 0, 0)
        self.tab_nav.layout.addWidget(next_button, 0, 1)
        self.tab_nav.layout.addWidget(lswap_button, 1, 0)
        self.tab_nav.layout.addWidget(rswap_button, 1, 1)
        self.tab_nav.layout.addWidget(flip_button, 2, 0)
        self.tab_nav.layout.addWidget(clear_button, 2, 1)
        self.tab_nav.layout.addWidget(delete_button, 3, 1)
        self.tab_nav.layout.addLayout(hbox_zoom, 3, 0)
        self.tab_nav.layout.addLayout(hbox_name, 4, 0)
        self.tab_nav.layout.addWidget(undo_button, 4, 1)
        ...
        fname_label.setFixedHeight(25)
        self.fname_input.setFixedWidth(150)

        self.tab_disp = QtWidgets.QWidget()
        self.tab_disp.layout = QtWidgets.QGridLayout()
        self.tab_disp.layout.addWidget(self.show_lines_checkbox, 1, 0)
        self.tab_disp.layout.addWidget(self.show_labels_checkbox, 2, 0)
        self.tab_disp.layout.addWidget(self.log_scale_checkbox, 3, 0)
        self.tab_disp.layout.addWidget(self.amp_radio_button, 1, 1)
        self.tab_disp.layout.addWidget(self.phs_radio_button, 2, 1)
        self.tab_disp.layout.addWidget(self.cos_phs_radio_button, 3, 1)
        self.tab_disp.layout.addLayout(hbox_unwrap_gray, 1, 2)
        self.tab_disp.layout.addLayout(hbox_wrap_color, 2, 2)
        self.tab_disp.layout.addWidget(norm_phase_button, 3, 2)
        self.tab_disp.layout.addWidget(fname_label, 0, 4)
        self.tab_disp.layout.addWidget(self.fname_input, 1, 4)
        self.tab_disp.layout.addWidget(export_button, 2, 4)
        self.tab_disp.layout.addWidget(export_all_button, 3, 4)
        self.tab_disp.layout.addWidget(self.export_png_radio_button, 1, 5)
        self.tab_disp.layout.addWidget(self.export_bin_radio_button, 2, 5)
        ...
        self.tab_manual.layout = QtWidgets.QGridLayout()
        self.tab_manual.layout.addWidget(self.left_button, 2, 1)
        self.tab_manual.layout.addWidget(self.right_button, 2, 3)
        self.tab_manual.layout.addWidget(self.up_button, 1, 2)
        self.tab_manual.layout.addWidget(self.down_button, 3, 2)
        self.tab_manual.layout.addWidget(self.px_shift_input, 2, 2)
        self.tab_manual.layout.addWidget(self.manual_mode_checkbox, 1, 4)
        self.tab_manual.layout.addWidget(self.apply_button, 2, 4)
        self.tab_manual.layout.addWidget(self.reset_button, 3, 4)
        self.tab_manual.layout.addWidget(self.rot_counter_clockwise_button, 2, 5)
        self.tab_manual.layout.addWidget(self.rot_angle_input, 2, 6)
        self.tab_manual.layout.addWidget(self.rot_clockwise_button, 2, 7)
        ...
        self.tab_auto.layout = QtWidgets.QGridLayout()
        self.tab_auto.layout.addLayout(vbox_sh_rot_rb, 0, 0)
        self.tab_auto.layout.addWidget(alignButton, 0, 1)
        self.tab_auto.layout.addWidget(magnify_button, 1, 1)
        self.tab_auto.layout.addWidget(warpButton, 2, 1)
        self.tab_auto.layout.addLayout(vbox_sh_rot_bt, 0, 2)
        self.tab_auto.layout.addWidget(remag_button, 1, 2)
        self.tab_auto.layout.addWidget(rewarp_button, 2, 2)
        self.tab_auto.setLayout(self.tab_auto.layout)
        ...
        self.tab_holo.layout.addWidget(aperture_label, 0, 0)
        self.tab_holo.layout.addWidget(self.aperture_input, 1, 0)
        self.tab_holo.layout.addWidget(hann_win_label, 0, 1)
        self.tab_holo.layout.addWidget(self.hann_win_input, 1, 1)
        self.tab_holo.layout.addWidget(holo_no_ref_1_button, 2, 0)
        self.tab_holo.layout.addLayout(hbox_holo, 2, 1)
        self.tab_holo.layout.addWidget(holo_no_ref_3_button, 3, 0)
        self.tab_holo.layout.addWidget(sum_button, 3, 1)
        self.tab_holo.layout.addWidget(diff_button, 3, 2)
        self.tab_holo.layout.addWidget(amp_factor_label, 0, 2)
        self.tab_holo.layout.addWidget(self.amp_factor_input, 1, 2)
        self.tab_holo.layout.addWidget(amplify_button, 2, 2)
        ...
        self.tab_calc.layout.addWidget(sample_thick_label, 0, 0)
        self.tab_calc.layout.addWidget(self.sample_thick_input, 1, 0)
        self.tab_calc.layout.addWidget(calc_grad_button, 2, 0)
        self.tab_calc.layout.addWidget(calc_B_button, 3, 0)
        self.tab_calc.layout.addWidget(int_width_label, 0, 1)
        self.tab_calc.layout.addWidget(self.int_width_input, 1, 1)
        self.tab_calc.layout.addWidget(plot_button, 2, 1)
        self.tab_calc.layout.addWidget(threshold_label, 0, 2)
        self.tab_calc.layout.addWidget(self.threshold_input, 1, 2)
        self.tab_calc.layout.addWidget(filter_contours_button, 2, 2)
        ...
        self.tab_corr.layout.addWidget(bright_label, 0, 1)
        self.tab_corr.layout.addWidget(self.bright_slider, 1, 0)
        self.tab_corr.layout.addWidget(self.bright_input, 1, 1)
        self.tab_corr.layout.addWidget(reset_bright_button, 1, 2)
        self.tab_corr.layout.addWidget(cont_label, 2, 1)
        self.tab_corr.layout.addWidget(self.cont_slider, 3, 0)
        self.tab_corr.layout.addWidget(self.cont_input, 3, 1)
        self.tab_corr.layout.addWidget(reset_cont_button, 3, 2)
        self.tab_corr.layout.addWidget(gamma_label, 4, 1)
        self.tab_corr.layout.addWidget(self.gamma_slider, 5, 0)
        self.tab_corr.layout.addWidget(self.gamma_input, 5, 1)
        self.tab_corr.layout.addWidget(reset_gamma_button, 5, 2)
        ...
        self.tabs.addTab(self.tab_manual, 'Manual align.')
        self.tabs.addTab(self.tab_auto, 'Semi-auto align.')
        self.tabs.addTab(self.tab_holo, 'Holography')
        self.tabs.addTab(self.tab_calc, 'Magnetic field')
        self.tabs.addTab(self.tab_corr, 'Br/Ga/Co')
