...
class TriangulateWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        size_policy.setHeightForWidth(prev_button.sizePolicy().hasHeightForWidth())
        ...
        prev_button.setSizePolicy(size_policy)
        next_button.setSizePolicy(size_policy)
        lswap_button.setSizePolicy(size_policy)
        rswap_button.setSizePolicy(size_policy)
        flip_button.setSizePolicy(size_policy)
        name_it_button.setSizePolicy(size_policy)
        zoom_button.setSizePolicy(size_policy)
        delete_button.setSizePolicy(size_policy)
        clear_button.setSizePolicy(size_policy)
        undo_button.setSizePolicy(size_policy)
        self.name_input.setSizePolicy(size_policy)
        self.n_to_zoom_input.setSizePolicy(size_policy)
        ...
        self.amp_radio_button.setSizePolicy(size_policy)
        self.phs_radio_button.setSizePolicy(size_policy)
        self.cos_phs_radio_button.setSizePolicy(size_policy)
        self.gray_radio_button.setSizePolicy(size_policy)
        self.color_radio_button.setSizePolicy(size_policy)
        unwrap_button.setSizePolicy(size_policy)
        wrap_button.setSizePolicy(size_policy)
        export_button.setSizePolicy(size_policy)
        export_all_button.setSizePolicy(size_policy)
        norm_phase_button.setSizePolicy(size_policy)
        fname_label.setSizePolicy(size_policy)
        self.fname_input.setSizePolicy(size_policy)
        self.export_png_radio_button.setSizePolicy(size_policy)
        self.export_bin_radio_button.setSizePolicy(size_policy)
        ...
        self.tab_manual.layout.setColumnStretch(0, 1)
        self.tab_manual.layout.setColumnStretch(1, 2)
        self.tab_manual.layout.setColumnStretch(2, 2)
        self.tab_manual.layout.setColumnStretch(3, 2)
        self.tab_manual.layout.setColumnStretch(4, 2)
        self.tab_manual.layout.setColumnStretch(5, 2)
        self.tab_manual.layout.setColumnStretch(6, 2)
        self.tab_manual.layout.setColumnStretch(7, 2)
        self.tab_manual.layout.setColumnStretch(8, 1)
        self.tab_manual.layout.setRowStretch(0, 1)
        self.tab_manual.layout.setRowStretch(4, 1)
        ...
        self.tab_auto.layout.setColumnStretch(0, 1)
        self.tab_auto.layout.setColumnStretch(4, 1)
        self.tab_auto.layout.setRowStretch(0, 1)
        self.tab_auto.layout.setRowStretch(5, 1)
        self.tab_auto.layout.addWidget(self.shift_radio_button, 1, 1)
        self.tab_auto.layout.addWidget(self.rot_radio_button, 2, 1)
        self.tab_auto.layout.addWidget(alignButton, 1, 2, 2, 1)
        self.tab_auto.layout.addWidget(magnify_button, 3, 2)
        self.tab_auto.layout.addWidget(warpButton, 4, 2)
        self.tab_auto.layout.addWidget(reshift_button, 1, 3)
        self.tab_auto.layout.addWidget(rerot_button, 2, 3)
        self.tab_auto.layout.addWidget(remag_button, 3, 3)
        self.tab_auto.layout.addWidget(rewarp_button, 4, 3)
        ...
        self.tab_corr.layout.setRowStretch(5, 1)
